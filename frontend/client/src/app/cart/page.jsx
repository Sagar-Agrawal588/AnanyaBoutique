  ...
  const getItemData = (item) => {
    ...
    const variantLabel =
      ...
      (variant?.weight
        ...
        : "");
    const price = toNumber(item?.price ?? variant?.price ?? product?.price, 0);
    const originalPrice = toNumber(
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                  ...
                  <div className="flex-1 flex flex-col justify-between py-2">
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      <div className="flex items-center gap-4 bg-gray-50 p-1 rounded-2xl border border-gray-100">
                        ...
                        <span className="text-lg font-black w-6 text-center text-gray-900">
                          {data.quantity}
                        </span>
                        <button
                          onClick={() =>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-32 p-8 rounded-[3rem] bg-gray-900 text-white shadow-2xl overflow-hidden">
              ...
              <h2 className="text-2xl font-black mb-8 border-b border-white/10 pb-4 tracking-tight">
                Summary
              </h2>
              ...
              <div className="space-y-4 mb-8">
                ...
                <div className="pt-6 border-t border-white/10 flex justify-between items-end">
                  <div>
                    <p className="text-gray-400 font-bold uppercase tracking-widest text-[11px] mb-1">
                      Total Amount
                    </p>
