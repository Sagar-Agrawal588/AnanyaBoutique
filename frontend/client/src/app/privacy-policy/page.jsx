...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      "To the extent we use your personal data to market to you, we will provide you the ability to opt-out of such uses.",
  ...
  },
  {
    ...
    body: [
      ...
      "Once your information is in our possession or whenever you access your account information, we adhere to our security guidelines to protect it against unauthorised access and offer the use of a secure server.",
      "However, the transmission of information is not completely secure for reasons beyond our control.",
      "By using the Platform, the users accept the security implications of data transmission over the internet and the World Wide Web which cannot always be guaranteed as completely secure, and therefore, there would always remain certain inherent risks regarding use of the Platform.",
  ...
  },
  {
    ...
    body: [
      "You have an option to delete your account by visiting your profile and settings on our Platform, this action would result in you losing all information related to your account.",
  ...
  },
  {
    ...
    body: [
      ...
      "We may verify such requests before acting on our request.",
      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <section className="mt-8 rounded-2xl border border-slate-200 bg-slate-50 p-5">
            <h2 className="mb-3 text-xl font-bold text-slate-900">Grievance Officer</h2>
            <div className="space-y-1 text-sm text-slate-700">
              ...
              <p>
                <span className="font-semibold">Phone Time:</span> Monday - Friday (9:00 - 18:00)
              </p>
            </div>
          </section>
