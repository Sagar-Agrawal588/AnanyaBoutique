...
export default function MembershipCTA() {
  ...
  const [ctaButtonText, setCtaButtonText] = useState("Explore Plans");
  ...
  useEffect(() => {
    ...
    fetchDataFromApi("/api/membership/home-content/public").then((res) => {
      if (res?.success && res.data) {
        ...
        if (d.checkItems?.length) setCheckItems(d.checkItems);
        if (d.ctaButtonText) setCtaButtonText(d.ctaButtonText);
        if (d.ctaButtonLink) setCtaButtonLink(d.ctaButtonLink);
      }
    });
  }, []);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundColor: `color-mix(in srgb, ${flavor.color} 30%, transparent)`,
        }}
      />
      <div
        className="absolute bottom-0 left-0 w-80 h-80 rounded-full blur-[100px] pointer-events-none"
        style={{
          backgroundColor: `color-mix(in srgb, ${flavor.hover} 30%, transparent)`,
        }}
      />
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p
              className="text-lg font-medium mb-8 max-w-md"
              style={{
                color: `color-mix(in srgb, ${flavor.light} 80%, white)`,
              }}
            >
              {subtitle}
            </p>
                ...
                >
                  <span
                    ...
                    style={{
                      ...
                      boxShadow: `0 4px 12px color-mix(in srgb, ${flavor.color} 40%, transparent)`,
                    }}
                  >
            ...
            <motion.button
              onClick={() => router.push(ctaButtonLink)}
              ...
              style={{
                color: `color-mix(in srgb, ${flavor.color} 80%, #1a1a2e)`,
              }}
              onHoverStart={() => {}}
            >
              {ctaButtonText}
          ...
          >
            {benefits.map((item, i) => (
              ...
              >
                <div className="text-4xl mb-4 grayscale mix-blend-screen">
                  {item.emoji}
                </div>
                ...
                <p
                  ...
                  style={{
                    color: `color-mix(in srgb, ${flavor.light} 60%, white)`,
                  }}
                >
                  {item.description}
                </p>
