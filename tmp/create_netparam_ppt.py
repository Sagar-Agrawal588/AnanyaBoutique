...
BG = Path(r"D:\BogEcom\output\ppt-template-media\image1.jpeg")
CAMPUS = Path(r"D:\BogEcom\output\ppt-template-media\image2.png")
JECRC_LOGO = Path(r"D:\BogEcom\output\ppt-template-media\image3.jpeg")
COMPANY_LOGO = Path(r"D:\BogEcom\output\friend-report-media\netparam_logo_generated.png")
ARCH = Path(r"D:\BogEcom\output\netparam-ppt-media\image3.png")
FLOW = Path(r"D:\BogEcom\output\netparam-ppt-media\image4.png")
TEST = Path(r"D:\BogEcom\output\netparam-ppt-media\image5.png")
LEARN = Path(r"D:\BogEcom\output\netparam-ppt-media\image6.png")
