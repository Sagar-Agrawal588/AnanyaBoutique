...
foreach ($key in @("XPRESSBEES_EMAIL", "XPRESSBEES_PASSWORD", "XPRESSBEES_WEBHOOK_SECRET",
    ...
    "XPRESSBEES_PICKUP_WAREHOUSE", "XPRESSBEES_PICKUP_NAME",
    "XPRESSBEES_PICKUP_ADDRESS1", "XPRESSBEES_PICKUP_ADDRESS2",
    "XPRESSBEES_PICKUP_CITY", "XPRESSBEES_PICKUP_STATE",
    "XPRESSBEES_PICKUP_PINCODE", "XPRESSBEES_PICKUP_PHONE")) {
    if ($serverEnv[$key]) { $secrets[$key] = $serverEnv[$key] }
}
